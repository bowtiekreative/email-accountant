...
INSERT OR IGNORE INTO categories (name, domain, tx_type, tax_relevant, irs_line, sort_order) VALUES
    ...
    ('Social Media', 'personal', 'expense', 0, NULL, 147),
    ('E-Commerce', 'personal', 'expense', 0, NULL, 148),
    ('Loans & Financing', 'personal', 'expense', 0, NULL, 149),
    ('Suspected Scam', 'personal', 'expense', 0, NULL, 150),
    ('Other Personal Expense', 'personal', 'expense', 0, NULL, 151),
    -- ── Cross-domain ──
