...
INSERT INTO categories (name, domain, type, tax_relevant, irs_line, sort_order) VALUES
    ...
    ('Software & Subscriptions', 'business', 'expense', TRUE, 'Line 18', 10),
    ('Marketing & Advertising', 'business', 'expense', TRUE, 'Line 8', 11),
    ('Internet & Telecom', 'business', 'expense', TRUE, 'Line 25', 12),
    ('Office Supplies', 'business', 'expense', TRUE, 'Line 18', 13),
    ('Travel & Meals', 'business', 'expense', TRUE, 'Line 24', 14),
    ('Professional Services', 'business', 'expense', TRUE, 'Line 17', 15),
    ('Equipment & Hardware', 'business', 'expense', TRUE, 'Line 13', 16),
    ('Housing & Rent', 'personal', 'expense', FALSE, NULL, 20),
    ('Groceries', 'personal', 'expense', FALSE, NULL, 21),
    ('Entertainment', 'personal', 'expense', FALSE, NULL, 22),
    ('Dining Out', 'personal', 'expense', FALSE, NULL, 23),
    ('Healthcare', 'personal', 'expense', FALSE, NULL, 24),
    ('Personal Transport', 'personal', 'expense', FALSE, NULL, 25),
    ('Shopping', 'personal', 'expense', FALSE, NULL, 26),
    ('Employment Salary', 'personal', 'income', FALSE, NULL, 30),
    ('Investment Income', 'personal', 'income', FALSE, NULL, 31);
